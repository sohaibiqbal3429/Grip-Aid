<?php $head_title="Blog - Car Service & Repair HTML5 Template"?>
                ...
                <article class="te-post-item format-image">
                    ...
                    <div class="te-post-content-wrapper">
                        ...
                        <h3 class="te-post-title">
                            <a href="blog-details.php">10 Essential Car Maintenance Tips to Keep Your Vehicle Running Smoothly</a>
                        </h3>
                        <div class="te-post-content">
                           <p>It is a long established fact that a reader will be distracted by the readable content of a page when thr looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal the a distribution of letters, as opposed to using 'Content her</p>
                        </div>
                        <div class="te-read-more">
                            <a href="blog-details.php" class="te-theme-btn">READ MORE<i class="fa-solid fa-arrow-right-long"></i></a>
                        ...
                        <ul>
                            <li>
                                ...
                                <div class="te-latest-post-desc">
                                    ...
                                    <span class="te-latest-post-meta"><i class="fa-regular fa-calendar-days"></i>20 Aug,2022</span>
                                </div>
                            </li>
                            <li>
                                <div class="te-latest-post-thumb">
